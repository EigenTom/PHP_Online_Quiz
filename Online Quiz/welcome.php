...
<body>
    ...
    <div id="nav" class="navigator">
        <ul>
            ...
            <li style="float: right; list-style-type: none; text-decoration: none; font-size:12px;" onclick="">All Quizzes</li>
    ...
    <div class="bg">
        ...
        <div id="form" class="loginForm">
            ...
            <h1 style="position: absolute; top: 5px; left: 2.5vw; color: #333; width: 100%;"; >All Quizzes</h1>
            <div style="position: absolute; top: 100px; left: 0px; width: 100%; height: 70vh; overflow-y: auto; overflow-x: hidden max"> 
            <?php
                $str = "SELECT * FROM Quiz WHERE quiz_available='1'";
                    ...
                    echo ('<div style="position: relative; flex-direction: column; overflow-y: auto; overflow-x: hidden;">
                            ...
                            <div class="quizPermute">
                                ...
                                <div>
                                    ...
                                    <div style="position: relative; top: 10px; left: 15px; line-height: 15px; color: grey">Quiz Author: '.$row[2].'</div>
                                    
                                    <div style="position: relative; left: 15px; color: grey">Quiz Duration: '.$row[5].' min</div>
                                </div>

                                <div class="takeTest" onclick="self.location=`takeTest.php?q='.$row[0].'`">Take Test</div>
